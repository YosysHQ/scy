...
@pytest.mark.parametrize("amount,expected", [(1, [0, 0, 1, 0]), (-1, [1, 2, 3, 2])])
...
@pytest.mark.parametrize(
    "input_str,stmt,name,asgmt,body",
    [
...
def test_enable_stmt():
    task_tree = first_tree_from_string(
        dedent(
            """\
        cover a:
            enable cell b:
...
@pytest.fixture(
    params=[
        {"input_str": "cover a:\n cover b:\n\tcover c:", "expected_lens": [3, 1, 1]},
        {"input_str": "cover a:\n cover b:\n\t cover c:", "expected_lens": [3, 1, 1]},
        {"input_str": "cover a:\n cover b:\n\t trace c", "expected_lens": [3, 1, 1]},
    ]
)
...
@pytest.fixture(
    params=[
        ...
        {"input_str": "cover a\ncover b\ncover c", "len": 3, "trees": 3},
        {"input_str": "\ncover a\n cover b", "len": 1, "trees": 1},
        {"input_str": "cover a:\n cover b\n\ncover c", "len": 2, "trees": 2},
        {"input_str": "cover a\nempty\ncover b", "len": 3, "trees": 2},
        {"input_str": "\n\n\n", "len": 0, "trees": 0},
        {
            "input_str": "\n \n  \n",
            "len": 1,
            "trees": 0,
        },  # this one could (should?) be 0 instead
    ]
)
...
@pytest.fixture(
    params=[
        {"input_str": "cover a", "tree_lines": [1], "print_lines": (1, 1)},
        {"input_str": "\ncover a", "tree_lines": [2], "print_lines": (1, 1)},
        {
            "input_str": "cover a:\n cover b",
            "tree_lines": [1, 2],
            "print_lines": (1, 2),
